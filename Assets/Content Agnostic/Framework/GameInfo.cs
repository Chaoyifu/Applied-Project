...
public static class GameInfo
{
    ...
    public static Content mathContent = new MathContent("Trigonometric function", "This game content aims to test your understanding of trigonometric function concept. Remove the three pieces together in the same row or column with the same result.");
